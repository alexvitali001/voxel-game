...
const SMOOTHNESS_FACTOR : f64 = 0.1;
// const DENSITY_SQUASH : f64 = 0.5;
impl DimensionNoise {
    pub fn new(useed: u64) -> DimensionNoise {
        let continentalness_generator = Source::improved_perlin(named_seed(useed, "continentalness"))
            .fbm(5, 0.013, 2.0, 0.5)
        ...
        /*
        let density_generator = Source::improved_perlin(named_seed(useed, "density"))
